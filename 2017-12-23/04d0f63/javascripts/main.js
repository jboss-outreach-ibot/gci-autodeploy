...
var getContributors = function(page) {
  // Fetching contributors list from all repos
$.ajax({
      url: "https://api.github.com/orgs/jboss-outreach/repos?page=" + page
  }).done(function(allData) {
    allData.forEach(function(allContributors){
      $.ajax({
    url: allContributors.contributors_url + "?page=" + page
  });
  });
  }).done(function(data) {
    if (data.length === 0) {
