...
## Adding a mentor
To add a mentor you need to create a file with your Github username `.yml` in `_data/mentors` folder and please maintain the following format *EXACTLY* (replacing values where indicated):
