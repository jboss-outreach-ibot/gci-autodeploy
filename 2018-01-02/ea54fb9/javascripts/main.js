window.onload = function() {
  projectContributors("contact-groups-android");
  projectContributors("compressor-head-android");
  projectContributors("certifier");
  projectContributors("wiki-explorer");
  projectContributors("facebook-echo-bot");
  projectContributors("blog.jboss-outreach.org");
  projectContributors("lead-management-android");
  projectContributors("gci");
};

"use strict";

function projectContributors(name){
