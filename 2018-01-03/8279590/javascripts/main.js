...
async function loadContributors() {
  ...
  allContributors
    ...
    .forEach((contributor) => {
      ...
      html += "<img src=" + contributor.avatar_url + "><div class='contribs'><p style='margin-top: -20.5px !important;'>";
      html += "<p style='font-size:30px; !important>'" contributor.contributions + "</p> contribution";
